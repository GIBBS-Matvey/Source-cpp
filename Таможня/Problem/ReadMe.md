...
На первой строке входного файла задано число `N`
 ($0 \leq N
 \leq 50 000$). На следующих `N`
 строках находится по 2 целых положительных числа $T_i$
 и $L_i$
 – время прибытия соответствующего груза и время, требуемое для его обработки $(1 \leq T_i \leq 10^6, 1 \leq L_i \leq 10^6)$.
