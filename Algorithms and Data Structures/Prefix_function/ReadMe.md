...
Тогда количество операций для вычисления всех значений pref[i], 0 $\leq$ i $\leq$ |p| - 1 не превосходит pref[0] - pref[|p| - 1] + 2|p|, при этом pref[0] - pref[|p| - 1] $\leq$ |p|. Итого суммарное время работы не превосходит 3|p|.
